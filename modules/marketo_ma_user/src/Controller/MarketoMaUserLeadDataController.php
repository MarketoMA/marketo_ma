...
/**
 * Class MarketoMaUserLeadDataController.
 *
 * @package Drupal\marketo_ma_user\Controller
 */
class MarketoMaUserLeadDataController extends ControllerBase {
  ...
  public function viewActivity(UserInterface $user) {
    ...
    $enabled_activities = $this->marketo_ma_user_service->config()->get('enabled_activities');
