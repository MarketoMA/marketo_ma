...
class MarketoMaUserSettings extends ConfigFormBase {
   ...
   */
  protected $marketo_ma_user_service;
   ...
   */
  public function __construct(ConfigFactoryInterface $config_factory, MarketoMaServiceInterface $marketo_ma_service, MarketoMaUserServiceInterface $marketo_ma_user_service, EntityFieldManagerInterface $entity_field_manager) {
    parent::__construct($config_factory);
    $this->marketo_ma_service = $marketo_ma_service;
    $this->marketo_ma_user_service = $marketo_ma_user_service;
    $this->entity_field_manager = $entity_field_manager;

    // Set the one and only config item name.
    $this->config_name = MarketoMaUserServiceInterface::MARKETO_MA_USER_CONFIG_NAME;
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $options = $this->marketo_ma_user_service->getActivitiesAsTableSelectOptions();
    ...
    $form['user_settings_tab']['group_activities']['activity_api_retrieve_activities'] = [
      ...
      '#disabled' => !$this->marketo_ma_service->apiClientCanConnect(),
      '#ajax' => [
  ...
  public function retrieveApiActivities(array &$form, FormStateInterface $form_state) {
    ...
    $options = $this->marketo_ma_user_service->getActivitiesAsTableSelectOptions(TRUE);
  ...
  protected function getMarketoFields() {
    ...
    }, $this->marketo_ma_service->getEnabledFields());
  }
